    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backend', models.CharField(choices=[('openai', 'OpenAI')], default='openai', help_text="Backend provider for this endpoint (currently only 'openai' is supported).", max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='models', to='management.endpoint')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endpoint', models.ForeignKey(help_text='The endpoint to which this request was made', on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='management.endpoint')),
                ('model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='requests', to='management.model')),
                ('token', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='management.token')),
            ],
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['token', 'timestamp'], name='management__token_i_84e9f4_idx'), models.Index(fields=['model', 'timestamp'], name='management__model_i_8f68c8_idx')],
            },
        ),
