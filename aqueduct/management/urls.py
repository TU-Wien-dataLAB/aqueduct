...
urlpatterns = [
    ...
    path(
        "team/<int:id>/service-accounts/add/", views.ServiceAccountCreateView.as_view(), name="service_account_create"
    ),
    path(
    ...
    path("vector-stores/<str:id>/", views.VectorStoreDetailView.as_view(), name="vector_store_detail"),
    path(
