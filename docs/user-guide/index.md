...
The main sections of the Aqueduct AI Gateway are the Tokens page, Teams page, Models page, Usage Dashboard, Files page, Vector Stores page, Batches page, and the Admin Panel.
...
The Files page enables you to view and manage files. The Vector Stores page allows you to manage vector stores for semantic search and retrieval.
