...
class ImageGenerationAliasTest(GatewayIntegrationTestCase):
    """Test model alias resolution for image generation endpoint."""
    ...
    def test_image_generation_with_alias(self):
        ...
        # Create a mock image response for fast testing
